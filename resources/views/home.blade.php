...
@section('home-content')
    ...
    <div class="panel panel-default" style="min-height: 50vh">
        ...
        <div class="panel-body" style="padding-left: 0px;padding-right: 0px;padding-bottom: 0px;padding-top: 15px">
            <div class="table-responsive">
                <table id="table-company" class="table table-hover">
                    <thead>
                    <tr>
                        <th style="min-width: 400px">Tên công ty</th>
                        <th style="min-width: 120px">Ngày thành lập</th>
                        <th style="min-width: 360px">Địa chỉ</th>
